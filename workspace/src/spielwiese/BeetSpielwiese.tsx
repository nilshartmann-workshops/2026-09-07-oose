...
/**
 * Ein Beet aus vielen hundert Pflanzen, über das sich eine Gießkanne ziehen
 * lässt. Bei gedrückter Maustaste wird jede überfahrene Pflanze gegossen.
 *
 * Die Spielwiese zeigt an einem Fall, den man sieht und fühlt, was der React
 * Compiler tut. Beim Ziehen ändert sich die Position der Kanne, und `Beet`
 * rendert deshalb bei jeder Mausbewegung. Ohne Compiler rendert damit auch
 * jede einzelne Pflanze mit, denn `giessen` ist bei jedem Durchlauf eine neue
 * Funktion, und daran scheitert das `memo` um `Pflanze`. Mit Compiler bleibt
 * die Funktion dieselbe, und es rendert nur die Pflanze, die gerade nass wird.
 *
 * ⚠️ Diese Datei ist fertig, du musst hier nichts implementieren.
 */
